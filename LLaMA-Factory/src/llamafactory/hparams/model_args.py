...
class ModelArguments:
    ...
    moelora_allocation: Optional[str] = field(
        metadata={
            "help": "the strategy for allocating the molora"
        },
        default=""
    )
    lora_allocation: Optional[str] = field(
        metadata={
            "help": "the strategy for allocating the molora"
        },
        default=""
    ...
    moe_type: Optional[str] = field(
        metadata={
            "help": "the molora structre"
        },
        default="topk"
    )
    unfreeze_module: Optional[str] = field(
        metadata={
            "help": "the freeze module"
        },
        default=None
    )
    blc_alpha: Optional[float] = field(
        metadata={
            "help": ""
        },
        default=0.9,
    )
    moelora_select: Optional[int] = field(
        metadata={
            "help": "if using the topk select strategy the number of expert to choose"
        },
        default=1,
    )
    moelora_alpha: Optional[int] = field(
        metadata={
            "help": ""
        },
        default=8,
    )
    moelora_rank: Optional[int] = field(
        metadata={
            "help": ""
        },
        default=8,
    ...
    moelora_dropout: Optional[float] = field(
        metadata={
            "help": ""
        },
        default=0.0,
    )
    blc_weight: Optional[float] = field(
        metadata={
            "help": ""
        },
        default=0.01,
