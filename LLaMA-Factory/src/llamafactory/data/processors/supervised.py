...
def _encode_supervised_example(
    ...
    for turn_idx, (source_ids, target_ids) in enumerate(encoded_pairs):
        ...
        if data_args.only_train_on_last_round:
...
###########################################################################################
def preprocess_supervised_dataset_CITI(
    ...
    model_inputs = {"input_ids": [], "attention_mask": [], "labels": [], "task_types": []}
    ...
    for i in range(len(examples["prompt"])):
        ...
        task_type = int(examples["task_types"][i])
        assert (task_type == 0 or task_type == 1)
        
        model_inputs["input_ids"].append(input_ids)
        model_inputs["attention_mask"].append([1] * len(input_ids))
        model_inputs["labels"].append(labels)
        model_inputs["task_types"].append(task_type)
