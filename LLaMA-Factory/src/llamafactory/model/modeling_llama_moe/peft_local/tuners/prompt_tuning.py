...
class PromptTuningInit_local(str, enum.Enum):
    TEXT = "TEXT"
    RANDOM = "RANDOM"


@dataclass
class PromptTuningConfig_local(PromptLearningConfig_local):
    """
    ...
    prompt_tuning_init: Union[PromptTuningInit_local, str] = field(
        default=PromptTuningInit_local.RANDOM,
    ...
    def __post_init__(self):
        self.peft_type = PeftType_local.PROMPT_TUNING


class PromptEmbedding_local(torch.nn.Module):
    """
    ...
    **Attributes**:
    ...
    def __init__(self, config, word_embeddings):
        ...
        if config.prompt_tuning_init == PromptTuningInit_local.TEXT:
