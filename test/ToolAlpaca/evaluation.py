...
if __name__ == "__main__":
    ...
    # the evaluation is done by openai gpt
    ...
    for api_info in api_data:
        ...
        for ques_id, ques in tqdm(enumerate(api_info["Instructions"])):
            ...
            solution += f"{sol_id + 2}. Final Response: {api_info['Instances'][ques_id]['output'] if 'output' in api_info['Instances'][ques_id].keys() else ''}"
            ...
            output = openai_chat_completions(prompt, model="gpt-4-0613", temperature=0) # gpt-4-0613
