...
from ..utils import PeftType_local, PromptLearningConfig_local


class PromptEncoderReparameterizationType_local(str, enum.Enum):
    MLP = "MLP"
    LSTM = "LSTM"


@dataclass
class PromptEncoderConfig_local(PromptLearningConfig_local):
    """
    ...
    encoder_reparameterization_type: Union[str, PromptEncoderReparameterizationType_local] = field(
        default=PromptEncoderReparameterizationType_local.MLP,
    ...
    **Attributes**:
    ...
    def __init__(self, config):
        ...
        if not config.inference_mode:
            if self.encoder_type == PromptEncoderReparameterizationType_local.LSTM:
            ...
            elif self.encoder_type == PromptEncoderReparameterizationType_local.MLP:
                warnings.warn(
